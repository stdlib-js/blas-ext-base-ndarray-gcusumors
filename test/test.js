...
tape( 'the function has an arity of 1', function test( t ) {
	t.strictEqual( gcusumors.length, 1, 'has expected arity' );
	t.end();
});

tape( 'the function computes the cumulative sum of a one-dimensional ndarray using ordinary recursive summation', function test( t ) {
	var expected;
	var initial;
	var xbuf;
	var x;
